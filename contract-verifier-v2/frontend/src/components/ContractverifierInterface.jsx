...
const ContractverifierInterface = () => {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'Contract-verifier-v2 Interface',
  ...
  const executeContractFunction = async (functionName, args) => {
    ...
    try {
      const txOptions = {
        ...
        contractName: 'contract-verifier-v2',
        functionName,
        functionArgs: args,
  ...
  return (
    <div className="contract-verifier-v2-interface">
      <h2>Contract-verifier-v2 Interface</h2>
      {!userSession ? (
...
export default ContractverifierInterface;
