...
const CrowdfundplatformInterface = () => {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'Crowdfund-platform-v2 Interface',
  ...
  const executeContractFunction = async (functionName, args) => {
    ...
    try {
      const txOptions = {
        ...
        contractName: 'crowdfund-platform-v2',
        functionName,
        functionArgs: args,
  ...
  return (
    <div className="crowdfund-platform-v2-interface">
      <h2>Crowdfund-platform-v2 Interface</h2>
      {!userSession ? (
