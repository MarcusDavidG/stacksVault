...
const appMetadata = {
  ...
  description: "A dApp for interacting with the Crowdfund Platform contract.",
...
const contractName = "crowdfund-platform";
...
function App() {
  ...
  const [title, setTitle] = useState("My Awesome Campaign");
      ...
      const { txid } = await signClient.request({
        ...
        request: {
          ...
          params: {
            ...
            // broadcast: true, // Wallet will broadcast if true
            network: "mainnet",
          },
        },
      });
  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <div className="card">
          <p>Create a new crowdfunding campaign on Stacks Mainnet.</p>
          <div>
            <label>Title: </label>
          ...
          <button onClick={createCampaign} disabled={!address || loading}>
