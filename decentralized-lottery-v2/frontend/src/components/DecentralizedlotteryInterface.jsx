...
const DecentralizedlotteryInterface = () => {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'Decentralized-lottery-v2 Interface',
  ...
  const executeContractFunction = async (functionName, args) => {
    ...
    try {
      const txOptions = {
        ...
        contractName: 'decentralized-lottery-v2',
        functionName,
        functionArgs: args,
  ...
  return (
    <div className="decentralized-lottery-v2-interface">
      <h2>Decentralized-lottery-v2 Interface</h2>
      {!userSession ? (
...
export default DecentralizedlotteryInterface;
