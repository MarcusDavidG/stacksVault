...
const DigitalwillInterface = () => {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'Digital-will-v2 Interface',
  ...
  return (
    <div className="digital-will-v2-interface">
      <h2>Digital-will-v2 Interface</h2>
      {!userSession ? (
...
export default DigitalwillInterface;
