...
const appMetadata = {
  ...
  description: "A dApp for interacting with the Lending Pool V2 contract.",
...
const contractName = "lending-pool-v2";
  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <div className="card">
          <p>Deposit STX to the lending pool on Stacks Mainnet.</p>
          <div>
