...
const LendingpoolInterface = () => {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'Lending-pool-v2 Interface',
  ...
  return (
    <div className="lending-pool-v2-interface">
      <h2>Lending-pool-v2 Interface</h2>
      {!userSession ? (
...
export default LendingpoolInterface;
