...
const appMetadata = {
  name: "Multisig Wallet V2",
  description: "A dApp for interacting with the Multisig Wallet V2 contract.",
...
const contractName = "multisig-wallet-v2";
  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <div className="card">
          <p>Deposit STX to the multisig wallet on Stacks Mainnet.</p>
          <div>
            <label>Amount (micro-STX): </label>
            <input type="number" value={depositAmount} onChange={(e) => setDepositAmount(parseInt(e.target.value) || 0)} />
          </div>
          <button onClick={deposit} disabled={!address || loading || depositAmount <= 0}>
