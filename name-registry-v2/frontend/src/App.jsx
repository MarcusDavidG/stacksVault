...
const appMetadata = {
  name: "Name Registry V2",
  description: "A dApp for interacting with the Name Registry V2 contract.",
...
const contractName = "name-registry-v2";
...
function App() {
  ...
  const [nameToRegister, setNameToRegister] = useState("my-name-v2");
