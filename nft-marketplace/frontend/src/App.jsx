...
const appMetadata = {
  ...
  description: "A dApp for interacting with the NFT Marketplace contract.",
...
function App() {
  ...
  // NFT Listing state
  const [nftContract, setNftContract] = useState("SPTEST.test-nft"); // Placeholder for an NFT contract
  const [tokenId, setTokenId] = useState(1);
  const [price, setPrice] = useState(1000000); // 1 STX
  const [royaltyPercent, setRoyaltyPercent] = useState(1000); // 10% (1000 = 10.00%)
  const [creatorAddress, setCreatorAddress] = useState("SPTEST.test-nft-creator"); // Placeholder
