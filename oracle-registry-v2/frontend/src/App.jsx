...
const appMetadata = {
  name: "Oracle Registry V2",
  description: "A dApp for interacting with the Oracle Registry V2 contract.",
...
const contractName = "oracle-registry-v2";
...
function App() {
  ...
  const [oracleName, setOracleName] = useState("MyOracleV2");
