...
const contractName = "secure-escrow-v2";
...
function App() {
  ...
  const [sellerAddress, setSellerAddress] = useState("SPTEST.test-seller-v2"); // Example principal
  const [arbiterAddress, setArbiterAddress] = useState("SPTEST.test-arbiter-v2"); // Example principal
  const [escrowAmount, setEscrowAmount] = useState(5000000); // 5 STX
  const [description, setDescription] = useState("Product/Service description V2");
